...
public class WorldGenCustomBigTree extends WorldGenAbstractTree
{
    ...
    List<WorldGenCustomBigTree.FoliageCoordinates> foliageCoords;

    public WorldGenCustomBigTree(boolean notify, IBlockState log, IBlockState leaf)
    {
        super(notify);
        this.log = log;
        this.leaf = leaf;
    ...
    void generateLeafNodeList()
    {
        ...
        this.foliageCoords = Lists.<WorldGenCustomBigTree.FoliageCoordinates>newArrayList();
        this.foliageCoords.add(new WorldGenCustomBigTree.FoliageCoordinates(this.basePos.up(k), j));
            ...
            if (f >= 0.0F)
            {
                for (int l = 0; l < i; ++l)
                {
                    ...
                    if (this.checkBlockLine(blockpos, blockpos1) == -1)
                    {
                        ...
                        {
                            this.foliageCoords.add(new WorldGenCustomBigTree.FoliageCoordinates(blockpos, blockpos2.getY()));
                        }
                    }
                }
            }
    ...
    void generateLeafNode(BlockPos pos)
    {
        ...
        {
            this.crosSection(pos.up(i), this.leafSize(i), this.leaf.withProperty(BlockLeaves.CHECK_DECAY, Boolean.valueOf(false)));
        }
    }
    ...
    void limb(BlockPos p_175937_1_, BlockPos p_175937_2_)
    {
        ...
        for (int j = 0; j <= i; ++j)
        {
            ...
            this.setBlockAndNotifyAdequately(this.world, blockpos1, this.log.withProperty(BlockLog.LOG_AXIS, blocklog$enumaxis));
        }
    }
    ...
    void generateLeaves()
    {
        for (WorldGenCustomBigTree.FoliageCoordinates worldgenbigtree$foliagecoordinates : this.foliageCoords)
        {
