...
public abstract class BlockCustomCrops extends BlockBush implements IGrowable
{
    ...
    public void updateTick(World worldIn, BlockPos pos, IBlockState state, Random rand)
    {
        ...
        if (worldIn.getLightFromNeighbors(pos.up()) >= 9)
        {
            ...
            if (i < this.getMaxAge())
            {
                ...
                {
                	IBlockState nstate = this.withAge(i + 1);
                    worldIn.setBlockState(pos, nstate, 2);
                    if(age < getAge(nstate)){
        				onGrown(worldIn, pos, nstate, rand);
        			}
    ...
    public abstract ItemStack getCrop(IBlockAccess world, BlockPos pos, IBlockState state, int fortune);
    public abstract ItemStack getSeed(IBlockAccess world, BlockPos pos, IBlockState state, int fortune);
    ...
    public java.util.List<ItemStack> getDrops(IBlockAccess world, BlockPos pos, IBlockState state, int fortune)
    {
        ...
        if (age >= getMaxAge())
        {
            ...
            for (int i = 0; i < 3 + fortune; ++i)
            {
                ...
                {
                    ret.add(this.getSeed(world, pos, state, fortune));
                }
            }
        }
        return ret;
    ...
    {
        return Items.AIR;//This should not be called!!
    }

    @Override
    public ItemStack getItem(World worldIn, BlockPos pos, IBlockState state)
    {
        return this.getSeed(worldIn, pos, state, 0);
    }
