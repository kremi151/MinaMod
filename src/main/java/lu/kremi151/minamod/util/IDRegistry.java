...
public class IDRegistry {
	...
	public static final int entityIceGolhemId = 0;
	public static final int entitySoulPearlId = 1;
	//TODO: public static final int entityTradesmanId = 2;
	public static final int entityBeeId = 3;
	public static final int entityIceSentinelId = 4;
	public static final int entityFrostBallId = 5;
	public static final int entityTurtleId = 6;
	public static final int entityRmpPrimedId = 7;
	public static final int entityPenguinId = 8;
	public static final int entityWookieId = 9;
	//Free id 10
	...
	public static final int guiIdGenerator = 16;
	public static final int guiIdCompressor = 17;
}
