...
import lu.kremi151.minamod.biome.decorator.BiomeDecoratorPalmBeach;
...
//	}
	...
	@SubscribeEvent
	public void onReplaceBiomeDecorator(BiomeEvent.CreateDecorator event){
		if(event.getBiome() == Biomes.BEACH){
			MinaMod.getLogger().info("Substituting Beach biome decorator...");//TODO: Remove
			event.setNewBiomeDecorator(new BiomeDecoratorPalmBeach());
		}
	}
