...
import lu.kremi151.minamod.item.amulet.AmuletEnder;
import lu.kremi151.minamod.item.amulet.AmuletExperience;
import lu.kremi151.minamod.item.amulet.AmuletRegeneration;
import lu.kremi151.minamod.item.amulet.AmuletReturn;
...
public class MinaItems {
	...
	public static final Item AMULET_OF_ENDER = new ItemAmulet(new AmuletEnder()).setUnlocalizedName("amulet_of_ender");
	public static final Item AMULET_OF_EXPERIENCE = new ItemAmulet(new AmuletExperience()).setUnlocalizedName("amulet_of_experience");
	public static final Item AMULET_OF_RETURN = new ItemAmulet(new AmuletReturn()).setUnlocalizedName("amulet_of_return");
	public static final Item AMULET_OF_REGENERATION = new ItemAmulet(new AmuletRegeneration()).setUnlocalizedName("amulet_of_regeneration");
